...
def generate_launch_description():
    ...
    controller_file = '/home/heisenberg_31/ros2_ws/src/urdf_tutorial/config/ur5_control.yaml'
    robot_description = {"robot_description": urdf_file}

    # Include Gazebo launch file
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource("/home/heisenberg_31/ros2_ws/src/urdf_tutorial/launch/ur5_gazebo.launch.py"),
    )
